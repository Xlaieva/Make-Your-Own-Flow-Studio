...
export async function getTokenUsage(params?: {
  ...
  const res: any = await request.get('/token-usage', { params })
  return res.data
}
...
export async function getCostReport(params?: {
  ...
  const res: any = await request.get('/token-usage/cost-report', { params })
  return res.data
}
...
export async function getModelRanking(params?: {
  ...
  const res: any = await request.get('/token-usage/model-ranking', { params })
  return res.data
}
